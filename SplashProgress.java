...
public class SplashProgress {
	...
	public static void drawSplash(TextureManager tm) {
		...
		if (splash == null) {
			splash = new ResourceLocation("coffeemod/splash.png");
		}
	...
	private static void drawProgress() {
		...
		ufr.drawString(step, sr.getScaledWidth() - 20 - ufr.getStringWidth(step), sr.getScaledHeight(), 0xe1e1e1FF);
		
		GlStateManager.resetColor();
		resetTextureState();
		
		Gui.drawRect(0, sr.getScaledHeight() - 2, (int)calc, sr.getScaledHeight(), new Color(149, 201, 144, 50).getRGB());
